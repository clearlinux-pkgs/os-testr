...
Version  : 2.0.0
Release  : 36
URL      : http://tarballs.openstack.org/os-testr/os-testr-2.0.0.tar.gz
Source0  : http://tarballs.openstack.org/os-testr/os-testr-2.0.0.tar.gz
Source1  : http://tarballs.openstack.org/os-testr/os-testr-2.0.0.tar.gz.asc
...
%prep
%setup -q -n os-testr-2.0.0
cd %{_builddir}/os-testr-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594660823
...
cp %{_builddir}/os-testr-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/os-testr/294b43b2cec9919063be1a3b49e8722648424779
