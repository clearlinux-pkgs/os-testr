...
Version  : 0.7.0
Release  : 14
URL      : http://tarballs.openstack.org/os-testr/os-testr-0.7.0.tar.gz
Source0  : http://tarballs.openstack.org/os-testr/os-testr-0.7.0.tar.gz
